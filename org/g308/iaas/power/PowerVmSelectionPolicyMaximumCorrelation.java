...
public class PowerVmSelectionPolicyMaximumCorrelation extends PowerVmSelectionPolicy {
	 ...
	 */
	@Override
	public Vm getVmToMigrate(final MyPowerHost host) {
	 ...
	 */
	protected double[][] getUtilizationMatrix(final List<MyPowerVm> vmList) {
		int n = vmList.size();
	 ...
	 */
	protected int getMinUtilizationHistorySize(final List<MyPowerVm> vmList) {
