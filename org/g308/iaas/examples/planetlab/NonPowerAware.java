...
import org.g308.iaas.MyPowerDatacenterNonPowerAware;
...
//			List<Cloudlet> cloudletList = PlanetLabHelper.createCloudletListPlanetLab(brokerId, inputFolder);
			List<Vm> vmList = Helper.createVmPlanetLab(brokerId, inputFolder);
			List<MyPowerHost> hostList = Helper.createHostList(PlanetLabConstants.NUMBER_OF_HOSTS);
			
			MyPowerDatacenterNonPowerAware datacenter = (MyPowerDatacenterNonPowerAware) Helper.createDatacenter(
					"Datacenter",
					MyPowerDatacenterNonPowerAware.class,
					hostList,
