package org.g308.iaas.examples.power;
...
import org.g308.iaas.MyPowerDatacenter;
import org.g308.iaas.MyPowerHost;
import org.g308.iaas.power.PowerVmAllocationPolicyMigrationAbstract;
import org.g308.iaas.power.PowerVmAllocationPolicyMigrationInterQuartileRange;
import org.g308.iaas.power.PowerVmAllocationPolicyMigrationLocalRegression;
import org.g308.iaas.power.PowerVmAllocationPolicyMigrationLocalRegressionRobust;
import org.g308.iaas.power.PowerVmAllocationPolicyMigrationMedianAbsoluteDeviation;
import org.g308.iaas.power.PowerVmAllocationPolicyMigrationStaticThreshold;
import org.g308.iaas.power.PowerVmAllocationPolicySimple;
import org.g308.iaas.power.PowerVmSelectionPolicy;
import org.g308.iaas.power.PowerVmSelectionPolicyMaximumCorrelation;
import org.g308.iaas.power.PowerVmSelectionPolicyMinimumMigrationTime;
import org.g308.iaas.power.PowerVmSelectionPolicyMinimumUtilization;
import org.g308.iaas.power.PowerVmSelectionPolicyRandomSelection;
...
public abstract class RunnerAbstract {
	...
	/** The host list. */
	protected static List<MyPowerHost> hostList;
	...
	protected void initLogOutput(
		...
		if (isEnableOutput() && outputToFile) {
			...
			File folder2 = new File(outputFolder + "/iaaslog");
			if (!folder2.exists()) {
				folder2.mkdir();
			}

			File file = new File(outputFolder + "/iaaslog/"
	...
	protected void start(String experimentName, String outputFolder, VmAllocationPolicy vmAllocationPolicy) {
		...
		try {
			MyPowerDatacenter datacenter = (MyPowerDatacenter) Helper.createDatacenter(
					"Datacenter",
					MyPowerDatacenter.class,
					hostList,
					vmAllocationPolicy);
...
//			Helper.printHistoryOfCloudletList(cloudletList);
	...
	/**
	 * Gets the virtual machine allocation policy.
	 * 
	 * @param vmAllocationPolicyName the virtual machine allocation policy name
	 * @param vmSelectionPolicyName the virtual machine selection policy name
	 * @param parameterName the parameter name
	 * @return the virtual machine allocation policy
	 */
	...
	/**
	 * Gets the virtual machine selection policy.
	 * 
	 * @param vmSelectionPolicyName the virtual machine selection policy name
	 * @return the virtual machine selection policy
	 */
